...
if __name__ == "__main__":
    ...
    crf1 = sklearn_crfsuite.CRF(algorithm='l2sgd', c2=10)
    ...
    crf2 = sklearn_crfsuite.CRF(algorithm='l2sgd', c2=10)
    ...
    crf3 = sklearn_crfsuite.CRF(algorithm='l2sgd', c2=10)
    ...
    crf4 = sklearn_crfsuite.CRF(algorithm='l2sgd', c2=10)
    ...
    crf5 = sklearn_crfsuite.CRF(algorithm='l2sgd', c2=10)
