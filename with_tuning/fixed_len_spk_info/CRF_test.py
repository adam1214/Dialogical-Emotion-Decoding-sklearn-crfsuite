...
if __name__ == "__main__":
    ...
    predict_dict = {}
    crf1 = joblib.load('model/len_' + str(args.data_len) + '/' + args.dataset + '/Ses01.model')
    crf2 = joblib.load('model/len_' + str(args.data_len) + '/' + args.dataset + '/Ses02.model')
    crf3 = joblib.load('model/len_' + str(args.data_len) + '/' + args.dataset + '/Ses03.model')
    crf4 = joblib.load('model/len_' + str(args.data_len) + '/' + args.dataset + '/Ses04.model')
    crf5 = joblib.load('model/len_' + str(args.data_len) + '/' + args.dataset + '/Ses05.model')
